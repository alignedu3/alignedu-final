...
const big: React.CSSProperties = { fontSize: 28, color: 'var(--text-primary)', width: '100%', fontWeight: 700, lineHeight: 1.05 };
const statLabel: React.CSSProperties = { color: 'var(--text-secondary)', fontSize: 13, marginBottom: 2, fontWeight: 600 };
const statSub: React.CSSProperties = { fontSize: 13, color: 'var(--text-secondary)', marginTop: 2, lineHeight: 1.45, maxWidth: 184 };
