...
const priorityCard: React.CSSProperties = { background: 'var(--surface-card-solid)' };
...
const hierarchyCard: React.CSSProperties = { border: '1px solid rgba(148,163,184,0.18)', borderRadius: 16, padding: 18, marginBottom: 14, background: 'var(--surface-card-solid)', boxShadow: '0 18px 36px rgba(15,23,42,0.06)' };
...
const hierarchyGroupCard: React.CSSProperties = { border: '1px solid rgba(148,163,184,0.16)', borderRadius: 14, padding: 14, background: 'var(--surface-card-solid)' };
