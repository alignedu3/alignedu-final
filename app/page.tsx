    ...
    <main style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <button onClick={() => {console.log("Demo Button Clicked!"); router.push("/analyze");}} className="demo-button" style={primaryBtn} onClick={() => router.push('/analyze')} style={primaryBtn}>
            Try It Now
          </button>

          <button onClick={() => {console.log("Demo Button Clicked!"); router.push("/analyze");}} className="demo-button" style={primaryBtn}
            onClick={() =>
