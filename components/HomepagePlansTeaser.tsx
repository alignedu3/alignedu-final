...
const plans = [
  { name: 'Free', price: '$0', note: '2 analyses / month', offer: 'AI lesson intelligence · Coverage, clarity, engagement & assessment · Personal dashboard', cta: 'Get started free' },
  { name: 'Teacher', price: '$14.99', cadence: '/month', annual: '$149/year', effective: '$12.42/mo', savings: 'Save $30.88/year', note: '10 analyses / month', offer: 'Everything in Free · Analysis history · Instructional insights', cta: 'Choose Teacher' },
  { name: 'Teacher Pro', price: '$24.99', cadence: '/month', annual: '$249/year', effective: '$20.75/mo', savings: 'Save $50.88/year', note: '30 analyses / month', offer: 'Everything in Teacher · More monthly analyses · Deeper instructional insights', cta: 'Choose Teacher Pro', featured: true },
  { name: 'School / District', price: 'Custom', note: 'Organization access', offer: 'Team access · District dashboard · Monitoring dashboard · Centralized oversight', cta: 'Request School / District' },
];
