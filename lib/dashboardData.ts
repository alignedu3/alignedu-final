...
export const sampleReports: LessonReport[] = [
  ...
  buildSampleReport('4', 'Ms. Carter', 'Mitosis and Meiosis', '2026-02-06', { coverage: 88, clarity: 84, engagement: 81, assessment: 75, gaps: 2 }),
  buildSampleReport('5', 'Ms. Carter', 'Enzymes', '2026-02-20', { coverage: 89, clarity: 86, engagement: 82, assessment: 77, gaps: 1 }),
  buildSampleReport('6', 'Ms. Carter', 'Cellular Respiration', '2026-03-06', { coverage: 90, clarity: 87, engagement: 84, assessment: 78, gaps: 1 }),
  buildSampleReport('7', 'Ms. Carter', 'Introduction to Ecosystems', '2026-03-20', { coverage: 91, clarity: 88, engagement: 85, assessment: 80, gaps: 1 }),
  buildSampleReport('8', 'Ms. Carter', 'Food Webs and Energy Flow', '2026-04-03', { coverage: 92, clarity: 89, engagement: 87, assessment: 81, gaps: 1 }),
